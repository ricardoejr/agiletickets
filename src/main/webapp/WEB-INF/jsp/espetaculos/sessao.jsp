...
<body>
	...
	<p>
		<span class="label">Descrição:</span> ${sessao.espetaculo.descricao }
	</p>
	<p>
		<span class="label">Duração:</span> ${sessao.duracaoEmMinutos }
		minutos
	</p>
	<p>
		...
		<form action="/sessao/${sessao.id}/reserva" method="post">
			<p>
				...
				<select name="desconto">
					...
					<option value="0.7">Estudante</option>
					<option value="0">Idoso</option>
				</select>
			<h3>Reservar ingresso</h3>
			<label for="qtde">Quantidade</label> <input id="qtde"
				name="quantidade" /> <input type="submit" value="Reservar" />
		</form>
	</c:if>
</body>
